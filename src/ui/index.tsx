 ...
 *  Templates are directly used on page routes `/src/pages/*` that also provide real data.
 * e.g. SeatManagementTemplate
 *
 * --------------------------------------------------------------------------------------------------------------------
 *
 ...
 *
 * @description
 * *Atoms* are UI elements that can't be broken down any further and serve
 *  as the elemental building blocks of an interface.
 * *Molecules* are collections of atoms that form relatively simple UI components.
 * *Organisms* are relatively complex components that form discrete sections
 *    of an interface.
 * *Templates* place components within a layout and demonstrate the design’s
 ...
 *    *note: These Pages are conceptually different from route-pages
 *           as their use is primarily for storybook presentation.*
 */
